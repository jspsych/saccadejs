...
// `saccadejs` is a peer dependency, so it stays external in every build. In the browser (IIFE)
// builds it has to be read off the `Saccade` global that the core's browser bundle defines.
