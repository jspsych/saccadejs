...
```
npm install saccadejs @saccadejs/extension @saccadejs/plugin-validate
```
...
| `roi_radius`                   | integer                               | `200`          | Radius in pixels of the region of interest around each point; samples inside it count towards `percent_in_roi`.                                                                                                                           |
